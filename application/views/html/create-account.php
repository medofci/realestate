...
<head>
    ...
    <link href="<?php echo base_url();?>application/assets/fonts/font-awesome.css" rel="stylesheet" type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>application/application/public/assets/css/jquery.slider.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url();?>public/assets/css/owl.carousel.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url();?>application/public/assets/css/style.css" type="text/css">

    <title>Crar Cuenta</title>
